...
const HELP_TEXT = [
	...
	"  --parentUpgradeMode MODE      proactive upgrade mode (direct|probe|shadow, default: shadow)",
	"  --parentUpgradeVerifyStaleRootCapacity 0|1 allow shadow probes against tracker-full root (default: 1 in shadow mode, otherwise 0)",
	...
	"  --parentShadowDualPathMs MS keep old parent during active-flow shadow cutover until candidate data is observed (default: 5000 in shadow mode, otherwise 0)",
	"  --parentShadowDualPathMinMessages N min candidate data messages before active-flow cutover (default: 32 in shadow mode, otherwise 1)",
