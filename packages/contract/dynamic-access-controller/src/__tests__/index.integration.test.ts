...
class TestStore<T extends BinaryPayload> extends CustomBinaryPayload {
...
describe('index', () => {
    ...
    it('can write from trust web', async () => {
        ...
        const l0a = await init(new TestStore(identity(0).publicKey), 0);
