...
import { LastWriteWins, FirstWriteWins, compare } from "../src/log-sorting.js";
...
describe("sorting", function () {
	...
	describe("last write wins", () => {
		...
		it("sorts by last write wins", async () => {
			...
			expect((await log.entryIndex.getBefore(e0))?.hash).to.be.undefined
			...
			expect((await log.entryIndex.getAfter(e3))?.hash).to.be.undefined
