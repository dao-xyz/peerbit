...
mod tests {
    use super::{
        ...
        signable_entry_to_signed_storage, trim_oldest_log_entry_hashes_core,
        unsigned_entry_v0_storage_for_signing, verify_prepared_entry_v0_ed25519_storage_slices_all,
