...
import { Sec256k1Keccak256Keypair, Secp256k1Keccak256PublicKey } from "./sepc256k1keccak256.js";
...
export const getKeypairFromPeerId = (peerId: PeerId): Ed25519Keypair | Sec256k1Keccak256Keypair => {
...
export const getPublicKeyFromPeerId = (peerId: PeerId): Ed25519PublicKey | Secp256k1Keccak256PublicKey => {
	if (peerId.type === 'Ed25519') {
