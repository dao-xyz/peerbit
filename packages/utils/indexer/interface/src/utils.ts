...
import { field, type SimpleField, type CustomField, type AbstractType, getSchema } from "@dao-xyz/borsh";
...
export const extractFieldValue = <T>(doc: any, path: string[], aliases?: Map<string, string>): T => {
