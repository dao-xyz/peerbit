...
export type IBinaryFeedStoreOptions<T> = IQueryStoreOptions<T, FeedIndex<T>> & { clazz: Constructor<T> };
...
export class BinaryFeedStore<T> extends Store<T, FeedIndex<T>, IBinaryFeedStoreOptions<T>> {
