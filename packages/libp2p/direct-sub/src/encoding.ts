import { Uint8ArrayView } from '@dao-xyz/libp2p-direct-stream'
import { Uint8ArrayList } from 'uint8arraylist'
import { field, vec, string, variant, serialize, deserialize } from '@dao-xyz/borsh';
export abstract class PubSubMessage {

	abstract serialize(): Uint8Array | Uint8ArrayList
	static deserialize(bytes: Uint8ArrayList | Uint8ArrayView) {
...
export const toUint8Array = (arr: Uint8ArrayList | Uint8Array) => arr instanceof Uint8ArrayList ? arr.subarray() : arr;


@variant(0)
export class PubSubData extends PubSubMessage {

	@field({ type: vec(string('u16'), 'u8') })
	topics: string[]

	@field({ type: Uint8Array })
	data: Uint8Array

	constructor(options: { topics: string[], data: Uint8Array | Uint8ArrayView }) {
		super();
		this.data = options.data instanceof Uint8Array ? options.data : options.data.subarray()
	...
	static deserialize(bytes: Uint8ArrayList | Uint8ArrayView): PubSubData {
...
export class Subscribe extends PubSubMessage {
	...
	static deserialize(bytes: Uint8ArrayList | Uint8ArrayView): Subscribe {
...
export class Unsubscribe extends PubSubMessage {
	...
	static deserialize(bytes: Uint8ArrayList | Uint8ArrayView): Unsubscribe {
...
export class GetSubscribers extends PubSubMessage {
	...
	static deserialize(bytes: Uint8ArrayList | Uint8ArrayView): GetSubscribers {
