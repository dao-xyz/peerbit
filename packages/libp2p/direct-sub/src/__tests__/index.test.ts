...
describe("pubsub", function () {
    ...
    describe("join/leave", () => {
        ...
        it("it can track subscriptions across peers", async () => {
            ...
            expect(
                peers[2].subscriptionEvents[0].from.equals(
                    peers[0].stream.publicKey
                )
            ).toBeTrue();
            expect(peers[2].subscriptionEvents[0].subscriptions).toHaveLength(
                1
            );
            expect(
                peers[2].subscriptionEvents[0].subscriptions[0].topic
            ).toEqual(TOPIC_1);
            expect(
            ...
            expect(
                peers[2].unsubscriptionEvents[0].from.equals(
                    peers[0].stream.publicKey
                )
            ).toBeTrue();
            expect(
                peers[2].unsubscriptionEvents[0].unsubscriptions
            ).toHaveLength(1);
            expect(
                peers[2].unsubscriptionEvents[0].unsubscriptions[0].topic
            ).toEqual(TOPIC_1);
        });
        ...
        it("can unsubscribe across peers", async () => {
            ...
            expect(peers[2].subscriptionEvents[1].subscriptions).toHaveLength(
                1
            );
            expect(
                peers[2].subscriptionEvents[1].subscriptions[0].topic
            ).toEqual(TOPIC_2);
            expect(
            ...
            expect(
                peers[2].unsubscriptionEvents[1].from.equals(
                    peers[0].stream.publicKey
                )
            ).toBeTrue();
            expect(
                peers[2].unsubscriptionEvents[1].unsubscriptions
            ).toHaveLength(1);
            expect(
                peers[2].unsubscriptionEvents[1].unsubscriptions[0].topic
            ).toEqual(TOPIC_2);
        });
        ...
        it("can override subscription metadata", async () => {
            ...
            expect(
                peers[1].stream.getSubscribersWithData(
                    TOPIC_1,
                    new Uint8Array()
                )
            ).toHaveLength(0);
            ...
            ).toEqual([peers[0].stream.publicKeyHash]);
            expect(
            ...
            expect(peers[1].subscriptionEvents).toHaveLength(2);
            expect(
                peers[2].subscriptionEvents[1].from.equals(
                    peers[0].stream.publicKey
                )
            ).toBeTrue();
            expect(peers[2].subscriptionEvents[1].subscriptions).toHaveLength(
            ...
            expect(
                peers[2].subscriptionEvents[2].from.equals(
                    peers[0].stream.publicKey
                )
            ).toBeTrue();
            expect(peers[2].subscriptionEvents[2].subscriptions).toHaveLength(
                1
            );
            expect(
                peers[2].subscriptionEvents[2].subscriptions[0].topic
            ).toEqual(TOPIC_1);
            expect(
                new Uint8Array(
                    peers[2].subscriptionEvents[2].subscriptions[0].data!
                )
            ).toEqual(data2);
