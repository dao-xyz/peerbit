...
export declare type IKeyValueStoreOptions<T> = IQueryStoreOptions<Operation<T>, T, KeyValueIndex<T>> & {
    clazz: Constructor<T>;
};
...
export declare class BinaryKeyValueStore<T> extends Store<Operation<T>, T, KeyValueIndex<T>, IKeyValueStoreOptions<T>> {
    _type: string;
