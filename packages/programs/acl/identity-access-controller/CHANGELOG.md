...
## [6.0.45](https://github.com/dao-xyz/peerbit/compare/identity-access-controller-v6.0.44...identity-access-controller-v6.0.45) (2026-07-02)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @peerbit/document bumped to 13.0.45
    * @peerbit/program bumped to 6.0.32
    * @peerbit/shared-log bumped to 13.1.19
    * @peerbit/trusted-network bumped to 6.0.45
  * devDependencies
