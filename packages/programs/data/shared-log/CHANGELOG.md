...
- [#1237](https://github.com/dao-xyz/peerbit/pull/1237) [`444bb71`](https://github.com/dao-xyz/peerbit/commit/444bb711d7f2ff38c6c570adddcd743f5ed4055d) Thanks [@peerbit-org](https://github.com/peerbit-org)! - Stop the entry recency map from growing without bound. `_entryKnownPeerObservedAt` records when each peer was last seen to know an entry, but it is only ever read through a 30-second window, and nothing removed rows on the entry dimension — so a node accumulated one row per (gossiped hash, peer) for its whole uptime, including hashes it never held. Rows past the longest read horizon are now dropped on the write path. Behaviour is unchanged: the sole reader already treats an over-age row and an absent row identically.

## 16.0.1

### Patch Changes

- [#1230](https://github.com/dao-xyz/peerbit/pull/1230) [`37ccb2b`](https://github.com/dao-xyz/peerbit/commit/37ccb2b0ac646874c2f63e8e28fe8fef0c1e13cf) Thanks [@peerbit-org](https://github.com/peerbit-org)! - Post-B12 residue cleanup. Internal only — no runtime behavior changes and nothing removed from the package's public entry.
...
- [#1214](https://github.com/dao-xyz/peerbit/pull/1214) [`ab270aa`](https://github.com/dao-xyz/peerbit/commit/ab270aaa65a767855747b88ab6c507ab385c6ae2) Thanks [@peerbit-org](https://github.com/peerbit-org)! - Bootstrap default V2 replication waits from an authoritative subscriber snapshot when the target's SharedLog subscription is missing or departing.
...
- [#1207](https://github.com/dao-xyz/peerbit/pull/1207) [`d01bbf7`](https://github.com/dao-xyz/peerbit/commit/d01bbf756997bdc2698ec473f303296121565c06) Thanks [@peerbit-org](https://github.com/peerbit-org)! - Activate authenticated replication-info V2 receive/apply with session-bound negotiation, sender sequence ordering, lifecycle recovery, and permanent per-session legacy cutover.
...
- [#1170](https://github.com/dao-xyz/peerbit/pull/1170) [`64813c2`](https://github.com/dao-xyz/peerbit/commit/64813c237699fd31488f380ddab20f4bd17c96e2) Thanks [@peerbit-org](https://github.com/peerbit-org)! - Copy coordinate metadata into exact-sized owned buffers, compact leader-selection recheck inputs, and isolate receive-role observer closures so replication state does not retain oversized exchange-message backing stores.
...
- [#1041](https://github.com/dao-xyz/peerbit/pull/1041) [`0a5a9a0`](https://github.com/dao-xyz/peerbit/commit/0a5a9a0c0690a310e141b80bcb84ba04fd48b329) Thanks [@peerbit-org](https://github.com/peerbit-org)! - Retry timed-out replication announcements from an authoritative current-state snapshot while preserving explicit caller errors, adaptive scheduling, and shutdown ordering. Make fixed-interval debouncer shutdown terminal so queued work cannot restart after close.
...
## [13.1.10](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.1.9...shared-log-v13.1.10) (2026-05-01)
...
## [13.1.7](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.1.6...shared-log-v13.1.7) (2026-04-30)
...
## [13.1.6](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.1.5...shared-log-v13.1.6) (2026-04-30)
...
## [13.0.20](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.0.19...shared-log-v13.0.20) (2026-03-27)
...
## [13.0.17](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.0.16...shared-log-v13.0.17) (2026-03-18)
...
- The following workspace dependencies were updated
  - dependencies
    ...
    - @peerbit/pubsub-interface bumped to 5.1.0
  - devDependencies
    - @peerbit/test-utils bumped to 3.0.15

## [13.0.16](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.0.15...shared-log-v13.0.16) (2026-03-17)
...
- The following workspace dependencies were updated
  - dependencies
    ...
    - @peerbit/pubsub-interface bumped to 5.0.7
    - @peerbit/stream-interface bumped to 6.0.6
  - devDependencies
    - @peerbit/test-utils bumped to 3.0.14

## [13.0.15](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.0.14...shared-log-v13.0.15) (2026-03-17)
...
- The following workspace dependencies were updated
  - dependencies
    ...
    - @peerbit/pubsub-interface bumped to 5.0.6
...
## [13.0.12](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.0.11...shared-log-v13.0.12) (2026-03-15)
...
- The following workspace dependencies were updated
  - dependencies
    ...
    - @peerbit/blocks bumped to 4.0.6
    - @peerbit/blocks-interface bumped to 2.0.4
    - @peerbit/pubsub bumped to 5.0.6
    - @peerbit/pubsub-interface bumped to 5.0.5
    - @peerbit/stream-interface bumped to 6.0.4
  - devDependencies
    - @peerbit/test-utils bumped to 3.0.11

## [13.0.11](https://github.com/dao-xyz/peerbit/compare/shared-log-v13.0.10...shared-log-v13.0.11) (2026-03-15)
...
- The following workspace dependencies were updated
  - dependencies
    ...
    - @peerbit/blocks bumped to 4.0.5
    ...
    - @peerbit/pubsub-interface bumped to 5.0.4
