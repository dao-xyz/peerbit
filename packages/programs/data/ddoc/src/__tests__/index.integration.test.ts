...
describe('index', () => {
  let session: Session, observer: IPFS, writer: IPFS, writeStore: DDocs<Document>, observerStore: DDocs<Document>, cacheStore1: Level, cacheStore2: Level
