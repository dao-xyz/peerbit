...
import { ComposableProgram, NetworkEvents, Program } from "@peerbit/program";
...
export class Documents<T extends Record<string, any>> extends ComposableProgram<
	DocumentEvents<T> & NetworkEvents
> {
	...
	async setup(options: SetupOptions<T>) {
