...
## [2.0.45](https://github.com/dao-xyz/peerbit/compare/document-proxy-v2.0.44...document-proxy-v2.0.45) (2026-07-02)
...
* The following workspace dependencies were updated
  * dependencies
    * @peerbit/canonical-client bumped to 1.1.35
    * @peerbit/canonical-host bumped to 1.0.41
    * @peerbit/document bumped to 13.0.45
    * @peerbit/document-interface bumped to 3.2.43
    * @peerbit/indexer-interface bumped to 3.0.5
    * @peerbit/program bumped to 6.0.32
    * @peerbit/shared-log-proxy bumped to 2.0.44
