...
3. Run the CI coverage shards you want to include:
   `pnpm run test:ci:part-1 && pnpm run test:ci:part-2a && pnpm run test:ci:part-2b && pnpm run test:ci:part-2c && pnpm run test:ci:part-3 && pnpm run test:ci:part-4 && pnpm run test:ci:part-5a && pnpm run test:ci:part-5b && pnpm run test:ci:part-6`
